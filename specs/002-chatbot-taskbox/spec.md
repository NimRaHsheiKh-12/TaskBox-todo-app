...
- **FR-018**: System MUST ensure Create/Add operations provide friendly confirmation (Constitution: CRUD Operations Details)
- **FR-019**: System MUST ensure Read/List operations show tasks in a clear, friendly format (Constitution: CRUD Operations Details)
- **FR-020**: System MUST ensure Update/Edit operations change existing tasks when asked (Constitution: CRUD Operations Details)
- **FR-021**: System MUST ensure Complete/Done operations mark tasks as completed and congratulate the user (Constitution: CRUD Operations Details)
- **FR-022**: System MUST ensure Delete operations remove tasks from the list when requested (Constitution: CRUD Operations Details)
- **FR-023**: System MUST validate all input on the backend (Constitution: Additional Constraints)
