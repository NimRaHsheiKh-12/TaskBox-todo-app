...
def test_chatbot_crud():
    ...
    print(f"   Reply: {create_data.get('reply', 'N/A')}")
    ...
    print(f"   Reply: {read_data.get('reply', 'N/A')}")
    ...
    if updated_tasks:
        ...
        print(f"   Reply: {update_data.get('reply', 'N/A')}")
    ...
    if updated_tasks:
        ...
        print(f"   Reply: {complete_data.get('reply', 'N/A')}")
    ...
    if updated_tasks:
        ...
        print(f"   Reply: {delete_data.get('reply', 'N/A')}")
