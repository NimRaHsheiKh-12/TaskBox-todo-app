...
class Settings(BaseSettings):
    ...
    hf_token: str = Field(default="", description="Hugging Face API token for accessing models")
    hf_model_name: str = Field(default="microsoft/DialoGPT-medium", description="Hugging Face model to use for chat")
    hf_max_tokens: int = Field(default=150, description="Maximum tokens for Hugging Face model generation")
    hf_temperature: float = Field(default=0.7, description="Temperature for Hugging Face model generation")
