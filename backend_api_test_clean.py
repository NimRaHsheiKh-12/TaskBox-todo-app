...
try:
    ...
    print(f"Success: {response.json().get('success', 'Unknown')}")
    print(f"Action performed: {response.json().get('action_performed', 'Unknown')}")
    print(f"Reply preview: {response.json().get('reply', 'No reply')[:50]}...")
